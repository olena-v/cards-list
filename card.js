export default class Card {
    ...
    getTemplate() {
      return `
        <div class="card">
          <div class="goods_photo" style="background-image: url(${this.state.images[0]})"></div>
          ...
          <div class="goods_name">${this.state.title}</div>
          <div class="goods_type">${this.state.category}</div>
